  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"></g-link>
          <g-link v-else to="/"></g-link>
        </div>
        ...
        >
          ...
          <li>
            <g-link to="/projects" class="text-copy-primary hover:text-gray-600" data-cypress="projects">Projects</g-link>
          </li>
          <li>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a href="https://github.com/iyanuashiri" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/iyanuashiri" target="_blank" class="text-white hover:text-gray-400">
